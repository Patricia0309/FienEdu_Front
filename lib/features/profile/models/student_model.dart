...
class Student {
  ...
  factory Student.fromJson(Map<String, dynamic> json) {
    var favCategoriesFromJson = json.containsKey('favorite_categories') && json['favorite_categories'] is List
    ...
    List<Category> favCategoryList = favCategoriesFromJson
        .map((catJson) => Category.fromJson(catJson as Map<String, dynamic>)) // Convierte cada item
        .toList();
    return Student(
      id: json['id'],
